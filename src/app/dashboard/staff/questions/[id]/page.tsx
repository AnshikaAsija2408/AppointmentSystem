...
export default function StaffQuestionDetails({ 
  params 
}: { 
  ...
  const submitResponse = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const detailsResponse = await fetch(`/api/questions/${questionId}`);
  ...
  // Function to close the question
